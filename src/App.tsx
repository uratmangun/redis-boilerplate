...
import { Heart, Github, Globe, Copy } from 'lucide-react'
...
function App() {
  const [currentPage, setCurrentPage] = useState<'home' | 'ai-search'>('home')
  ...
  if (currentPage === 'ai-search') {
    return (
      <ThemeProvider defaultTheme="system" storageKey="vite-ui-theme">
        <AISearchPage onBack={handleBackToHome} />
      </ThemeProvider>
    )
  }
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="flex justify-center mb-12">
          <Card className="hover:shadow-lg transition-shadow max-w-md w-full">
            ...
            <CardFooter>
              <Button variant="outline" className="w-full" onClick={handleNavigateToAISearch}>
                Try AI Search
              </Button>
            </CardFooter>
          </Card>
